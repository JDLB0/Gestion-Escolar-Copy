...
import './CreateStudent.css';  // Crea el archivo CSS correspondiente
...
const CreateStudent = () => {
  const [formData, setFormData] = useState({
    ...
    address: '',
    phone_number: '',
    grade: '',  // Campo añadido para el grado (curso)
    enrollment_date: '',
  });
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label htmlFor="grade">Grado</label>  {/* Campo para el grado */}
          <input
            type="text"
            id="grade"
            name="grade"
