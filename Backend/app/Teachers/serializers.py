...
#     class Meta:
#         model = Teacher
#         fields = ('id', 'user_id', 'full_name','birth_date', 'gender', 'address', 'phone_number', 'department', 'hire_date')
...
class TeacherSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        user_id = validated_data.pop('user_id').id  # Extraemos solo el ID del usuario
    ...
    def update(self, instance, validated_data):
        ...
        # Actualizamos los campos del modelo Teacher
